    ...
    <div class="max-w-6xl mx-auto px-4">
      ...
      <div class="h-14 hidden md:grid grid-cols-3 items-center">
        ...
        <div class="flex items-center">
          <a href="{{ url('/') }}" class="inline-flex items-center gap-2">
            <span class="font-extrabold text-2xl tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-sky-600 to-fuchsia-600">
              OmongIn
            </span>
          </a>
        </div>
      ...
      <div class="md:hidden" x-data="{ open: false }" @keydown.escape.window="open=false">
        <div class="h-14 flex items-center justify-between">
          {{-- Brand (mobile only) --}}
          <a href="{{ url('/') }}" class="inline-flex items-center gap-2">
            <span class="font-extrabold text-xl tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-sky-600 to-fuchsia-600">
              OmongIn
            </span>
          </a>
