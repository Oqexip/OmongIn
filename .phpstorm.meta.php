...
'delete','create','viewAny','view','update',
'restore','forceDelete',);
...
'signed','throttle','verified','role','anon',
'anonKey',);
        registerArgumentsSet('routes', 'vote.store','home','search.index','boards.show',
'threads.store','threads.show','comments.store','threads.update','threads.destroy',
'comments.update','comments.destroy','popular.index','dashboard','profile.edit',
...
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input','components.vote',
'dashboard','errors.404','home','layouts.app','layouts.guest',
'layouts.navigation','popular.index','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','search.index','threads.index','threads.partials.comment','threads.show',
